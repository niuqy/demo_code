...
public class ViewPagerMorePageOnScreenAct extends Activity{
	 ...
	 private int TOTAL_COUNT = imgs.length;
	 private int LIMIT_COUNT = 3;
	    ...
	    protected void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.view_pager_more_page);
	        ...
	        viewPager.setOffscreenPageLimit(LIMIT_COUNT);
	    ...
	    class MyPagerAdapter extends PagerAdapter {
	        ...
	        public Object instantiateItem(ViewGroup container, int position) {
	            ImageView imageView = new ImageView(ViewPagerMorePageOnScreenAct.this);
	    ...
	    public class MyOnPageChangeListener implements OnPageChangeListener {
	        ...
	        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
	            // to refresh frameLayout(actually there is no need to refresh the viewPagerContainer)
