 ...
 */
public class Anim_LayoutTransition_hideshow extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        customAnimCB.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                long duration;
                if (isChecked) {
                    mTransitioner.setStartDelay(LayoutTransition.CHANGE_APPEARING, 2000);
    ...
    private void setupCustomAnimations() {
        ...
        final ObjectAnimator changeIn = ObjectAnimator.ofPropertyValuesHolder(
                this,  pvhScaleX, pvhScaleY,pvhLeft, pvhTop, pvhRight, pvhBottom). //
